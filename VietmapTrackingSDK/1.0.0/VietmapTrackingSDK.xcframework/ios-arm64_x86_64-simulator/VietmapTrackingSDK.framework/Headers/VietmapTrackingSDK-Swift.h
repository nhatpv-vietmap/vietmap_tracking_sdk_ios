...
@interface VietmapTrackingSDK (SWIFT_EXTENSION(VietmapTrackingSDK)) <AVSpeechSynthesizerDelegate>
...
@interface VietmapTrackingSDK (SWIFT_EXTENSION(VietmapTrackingSDK))
...
@interface VietmapTrackingSDK (SWIFT_EXTENSION(VietmapTrackingSDK)) <CLLocationManagerDelegate>
